angular.module("serverApp").controller("MonitCtrl", ['$scope', '$http', '$interval', '$filter', '$window', '$location',  function($scope, $http, $interval, $filter, $window, $location) {
      ...
      var requestMonitoringData = function() {
            ...
            $scope.busy = $http({
                    method: 'GET',
                    url: '/iop-node/web/rest/api/v1/admin/monitoring/current/data'
                      ...
                      $scope.charData[1].push(data.registerActorsTotal);
  ...
  /*    var requestMonitInfo = function() {
              ...
              $scope.busy = $http({
                      method: 'GET',
                      url: '/iop-node/web/rest/api/v1/admin/monitoring/system/data'
                }).then(function successCallback(response) {
