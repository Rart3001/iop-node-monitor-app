...
@Entity
@NamedQueries({
    @NamedQuery(name="NetworkService.countOnlineByType",      query="SELECT ns.networkServiceType, COUNT(DISTINCT ns.networkServiceType) FROM NetworkService ns WHERE ns.sessionId IS NOT NULL GROUP BY ns.networkServiceType"),
    @NamedQuery(name="NetworkService.countOnline",            query="SELECT COUNT(ns.id) FROM NetworkService ns WHERE ns.sessionId IS NOT NULL"),
    @NamedQuery(name="NetworkService.getAllCheckedIn",        query="SELECT ns FROM NetworkService ns WHERE ns.sessionId IS NOT NULL"),
})
