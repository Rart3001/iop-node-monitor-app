...
public class AbstractBaseDao<E extends AbstractBaseEntity> {
     ...
     */
    public List<E> executeNamedQuery(String jpaNamedQuery, Map<String, Object> filters, boolean isUpdate) throws IllegalArgumentException {
        EntityManager connection = getConnection();
        ...
        try {
            ...
            TypedQuery<E> query = connection.createNamedQuery(jpaNamedQuery, entityClass);
            if(max > 0)
